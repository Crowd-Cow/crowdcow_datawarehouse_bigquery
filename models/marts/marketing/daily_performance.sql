...
,performance_previous_week as (
    ...
    where ((( calendar_date  ) >= ((TIMESTAMP(DATETIME_ADD(DATETIME(TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)), DAY), WEEK(SUNDAY))), INTERVAL -1 WEEK)))) AND ( calendar_date  ) < ((TIMESTAMP(DATETIME_ADD(DATETIME(TIMESTAMP(DATETIME_ADD(DATETIME(TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)), DAY), WEEK(SUNDAY))), INTERVAL -1 WEEK))), INTERVAL 1 WEEK))))))
)
,performance_last_year as (
    ...
    from plan_performance
    where ((( calendar_date  ) >= ((TIMESTAMP(DATETIME_ADD(DATETIME(TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)), DAY), WEEK(SUNDAY))), INTERVAL -52 WEEK)))) AND ( calendar_date  ) < ((TIMESTAMP(DATETIME_ADD(DATETIME(TIMESTAMP(DATETIME_ADD(DATETIME(TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)), DAY), WEEK(SUNDAY))), INTERVAL -52 WEEK))), INTERVAL 1 WEEK))))))
)
...
,performance_current_week as (
    ...
    from plan_performance
     where (((calendar_date) >= ((TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)), DAY), WEEK(SUNDAY)))) AND (calendar_date) < ((TIMESTAMP(DATETIME_ADD(DATETIME(TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)), DAY), WEEK(SUNDAY))), INTERVAL 1 WEEK))))))
...
,performance_month_to_date as (
    ...
    from plan_performance
    where ((( calendar_date  ) >= ((TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)), DAY), MONTH))) AND ( calendar_date  ) < ((TIMESTAMP(DATETIME_ADD(DATETIME(TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)), DAY), MONTH)), INTERVAL 1 MONTH))))))
    group by 1 
    order by 1 asc
)
...
,performance_quarter_to_date as (
 select 
   ...
   from plan_performance
    where  ((( calendar_date  ) >= ((TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)), DAY), QUARTER))) AND ( calendar_date  ) < ((TIMESTAMP(DATETIME_ADD(DATETIME(TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP_TRUNC(TIMESTAMP(DATE_SUB(CURRENT_DATE(), INTERVAL 1 DAY)), DAY), QUARTER), QUARTER)), INTERVAL 3 MONTH))))))
    group by 1 
    order by 1 asc
)
