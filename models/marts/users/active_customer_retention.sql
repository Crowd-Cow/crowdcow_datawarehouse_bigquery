...
, results as (
    select 
        ...
        count(distinct if(week_start_active_alc_180_days = 0 and week_end_active_alc_180_days > 0 and new_alc_customers = 0 and alc_alc_2_sub = 0 , final.user_id, null))  as alc_reactivated,
