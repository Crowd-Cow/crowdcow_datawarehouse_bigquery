...
,checkout_payment_selected as (
    select
        ...
        ,occurred_at_utc
    from event_checkout_payment_selected
)
,order_complete as (
    select
        visit_id
