...
,user_referral_programs as (select * from {{ ref('stg_cc__user_referral_program') }} )
...
,user_joins as (
    select
        ...
        ,user_order_activity.six_month_alc_orders
        ,user_order_activity.twelve_month_alc_orders
    ...
    from users
        ...
        left join user_referral_programs on users.user_id = user_referral_programs.user_id 
)
...
,final as (
    select
        ...
        ,six_month_alc_orders
        ,twelve_month_alc_orders
