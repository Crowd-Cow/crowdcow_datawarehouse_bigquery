...
,completed_orders as ( select order_id from {{ ref('stg_cc__orders') }} where (order_current_state in ('COMPLETE','FULLY_PACKED','FULLY_PACKED_AS_IS','SHIP_AS_IS') or order_id in (3331204,3335959,3335952,3335958) ) ) --hardcoded byb orders
