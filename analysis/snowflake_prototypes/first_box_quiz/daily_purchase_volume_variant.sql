/**** Daily Purchase by Variant Volume (by Visitor Token) | Experimental and Control ****/
...
-- , round(completed_orders::float / distinct_visitors,2) as completed_order_rate_pct
-- , round(completed_first_member_orders::float / distinct_visitors,2) as completed_member_order_rate_pct
-- , round(completed_non_member_orders::float / distinct_visitors,2) as non_member_completed_order_rate_pct
-- , round(paid_uncancelled_first_member_orders::float / distinct_visitors,2) as first_member_paid_order_rate_pct
from aggregates
