...
select
    ...
    ,count(distinct order_complete.visit_id)::float/count(distinct clicked_fbq_cta.visit_id)::float as "Pct FBQ Order Complete"
from clicked_fbq_cta
    left join order_complete on clicked_fbq_cta.visit_id = order_complete.visit_id
