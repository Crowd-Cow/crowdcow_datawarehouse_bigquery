...
/**** Purchase by Variant Volumes (by Visitor Token) | Experimental and Control ****/
...
select 
    ...
    -- ,completed_orders::float / distinct_visitors as completed_order_rate_pct
    -- ,completed_first_member_orders::float / distinct_visitors as completed_member_order_rate_pct
    -- ,completed_non_member_orders::float / distinct_visitors as non_member_completed_order_rate_pct
    -- ,paid_uncancelled_first_member_orders::float / distinct_visitors as first_member_paid_order_rate_pct
from aggregates
order by 1 desc;
